...
public class Exam02_5 {
    public static void main(String[] args) throws Exception {
        // Calendar 클래스의 생성자는 protexted 로 접근이 제한되어 있기 때문에
        // 다른 패키지에서 직접 생성자를 호출할수 없다.
        ...
        System.out.println(c.get(10)); //시(0 ~ 11시)
        ...
        System.out.println(c.get(Calendar.HOUR)); //시(0 ~ 11시)
