...
public class Exam02_2 {
    public static void main(String[] args) {
        ...
        // JDK1.5 부터 auto-boxing, auto-unboxing 기능을 제공한다.
        // => auto-boxing
        //    int 값으로 자동으로 Integer 랩퍼 객체를 만든다.
        //    이렇게 객체 안에 값을 넣어 포장한다고 해서 "오토박싱" 이라고 한다.
        ...
        int i3 = obj4; // 내부적으로 obj4.intValue() 로 바뀐다.
                       // 즉 obj4 에 들어있는 인스턴스 주소가 i3 에 저장되는 것이 아니라,
                       // obj4 인스턴스에 들어있는 값을 꺼내 i3 에 저장하는 것이다.
    }
