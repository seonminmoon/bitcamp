...
public class Exam02_4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 실행하기 전 해야할 일:
        // 1) test9_3.data 파일을 읽기 전에 Member2 클래스에 전화번호를 저장할 수 있는 인스턴스 변수를 추가한다.
        
        Member2 member = (Member2) in.readObject();
        // Serialize 데이터를 읽어 Member2 인스턴스를 생성하려고 하면
        // 실행 오류가 발생한다.
        // 이유?
        // => Serialize 데이터를 출력할 때 사용한 Mmeber2 클래스의 데이터 버전과
        //    Serialize 데이터를 읽을 때 사용한 Member2 클래스의 버전이 다르기 때문이다. (tel 추가했음)
        //
        // 어, Member2 를 작성할 때 버전 번호를 등록한 적이 없는데요?
        // => 클래스를 작성할 때 버전을 지정하지 않으면 
        //    컴파일러가 자동으로 임의의 버전 번호를 지정한다.
        // => private static final long serialVersionUID 변수를 만들어
        //    임의의 값을 저장한다.
        //
        // 그러면 모든 클래스가 serialVersionUID 라는 변수를 가지고 있나요?
