...
public class Exam02_1 {
    ...
    //    => 오류의 예:
    //       배열의 인덱스가 무효한 오류, I/O 오류, SQL 오류, Parse 오류, 데이터 포멧 오류 등
    ...
    // Exception 계열의 예외를 던질 때는 반드시 메서드 선언부에 ~~~~~~ ㄱ강사님
