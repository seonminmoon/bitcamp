...
public class Exam02_1 {
    ...
    // 문법
    // [리턴값의 타입] 함수명(파라미터선언, ...) {명렁어들}
    // - 리턴값의(return value) 타입? 
    ...
    public static void main(String[] args) {
        ...
        // [리턴값을 받을변수] = 메서드명(아규먼트);
        // - 아규먼트(argument)?
        //   => 메서드 블록에 들어 있는 명렁을 실행하기 위해 넘겨주는 값
        //   => 즉 파라미터 변수에 넘겨주는 값
        ...
        // hello 메서드는 파라미터 변수가 없기 때문에 호출할때 값을 받으려하면
        // hello(100); // 컴파일 오류!
        
        // hello 메서드는 값을 리턴하지 않기 때문에 변수로 값을 받으려하면
        int i;
        // i = hello(); // 컴파일 오류!
    }
}
