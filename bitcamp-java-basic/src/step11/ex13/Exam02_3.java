...
public class Exam02_3 extends C {
    public static void main(String[] args) {
        ...
        // getInstance()의 리턴값을 확인해보면 다르다는 것을 알 수 있다.
