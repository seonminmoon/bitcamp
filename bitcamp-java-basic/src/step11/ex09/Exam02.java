...
public class Exam02 {
    public static void main(String[] args) {
        ...
        // model 과 capacity 변수는 원래 Vehicle 설계도에 있는 변수이기 때문에
        ...
        // 실제 들어있는 객체의 주소로 판단하지 않고 레퍼런스가 어떤 클래스냐에 따라 판단한다.
        //v1.cc = 1980; // 컴파일 오류!
        //v1.valve = 16; // 컴파일 오류!
        //v1.sunroof = true;  // 컴파일 오류!
        //v1.auto = true; // 컴파일 오류!
        
        // 그럼에도 불구하고 레퍼런스가 실제 가리키는객체의 모든 메모리에 접근하고 싶은가?
        // => 형변환 하라!
        ((Sedan)v1).cc = 1980;
        ((Sedan)v1).valve = 16;
        ...
        s.auto = true; 
        System.out.printf("%s %d %d %d %b %b \n",
                s.model, s.capacity, s.cc, s.valve,
                s.sunroof, s.auto);
