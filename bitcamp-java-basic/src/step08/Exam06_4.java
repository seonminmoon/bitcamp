...
public class Exam06_4 {
    public static class A {
        ...
        static {
            System.out.println("Static{} 2222222");
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // A.a = 100; 
        System.out.println("------------------");
        A.m(); // 설계도 만들면 초기화 블록도 실행

        System.out.println("******************");
        // 2) 해당 클래스의 인스턴스를 최초로 생성할 때
        //    => 인스턴스를 만들려면 설계도가 있어야하고,
        //       설계도는 메모리에 로딩되어 있어야한다.
        //       따라서 설계도가 없으면 즉시 설계도를 로딩할 것이다.
        
        new A(); // 설계도 만들면 초기화 블록도 실행

        System.out.println("==================");
        // 3) 자바에서 제공하는 도구를 사용하여 강제로 클래스를 로딩시키는 경우
        //    => 이미 클래스가 로딩되어 있다면 다시 로딩하지 않는다. 메모리 절약!!
