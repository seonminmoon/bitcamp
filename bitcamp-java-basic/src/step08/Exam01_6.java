...
public class Exam01_6 {
    static class Member {
        ...
        //    클래스 변수로 만드는 것이 바람직하다 (메모리낭비X) - static
        // => 만약 값을 저장하는 것이 아닌 조회하는 용도로만 사용하는 변수라면
        //    대문자로 선언하여 상수임을 표현하라! - GUEST,MEMBER,MANAGER
        // => 조회 용도로만 사용하기로 했으면 문법적으로 값을 변경하는 것을 막아라! - final
        // => 보통 조회용으로 사용하는 변수는 공개해도 되기 때문에 public 으로 선언한다. - public
    ...
    public static void main(String[] args) {
        ...
        // 남의 소스코드를 유지보수하는 사람은 더더욱 숫자의 의미를 파악하기가 더욱 어렵다.
        // 주석이나 개발 문서를 자세히 살펴보지 않는 이상에는 숫자의 의미를 파악하기 쉽지 않다.
        //
        // "이런 경우를 방지하고자 나온 문법이 상수이다!"
        // => 즉 의미있는 이름으로 변수를 만들어놓고 그 변수에 숫자를 저장한다.
