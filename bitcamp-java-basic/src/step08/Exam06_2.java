...
public class Exam06_2 {
    public static void main(String[] args) {
        ...
        //
        // 혹시.. 그럼.. 생성자를 사용할 수 없는 상황에서 인스턴스 블록을 사용한다는 것입니까? YES
        // 생성자를 사용할 수 없는 경우가 있나요? YES
        // 예를 들어주세요!
        
        // 나중에 또 배우겠지만 지금은 맛만 보자!
        // "익명 클래스"
        // -> 클래스 이름 없어서 생성자도 없음. BUT 기본값으로 초기화시키고 싶다
