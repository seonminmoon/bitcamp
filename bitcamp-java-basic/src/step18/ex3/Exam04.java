...
public class Exam04 {
	...
	public static void main(String[] args) throws Exception {
		...
		// 파라미터가 있는 메서드를 찾을 때는 파라미터의 타입 정보를 넘기지 않는다.
		System.out.println(clazz.getMethod("m1").getName());
		
		// String 파라미터가 있는 메서드를 찾을 때는 그 파라미터의 타입 정보를 넘겨야 한다.
		// 타입정보 = 클래스정보 = class객체
		...
		// int = int.class
		// byte, short, int, long, float, double, boolean, char 은 비록 클래스는 아니지만,
		// 일반 클래스처럼 타입 정보를 꺼낼 수있도록 "class" 라는 변수를 제공한다.
