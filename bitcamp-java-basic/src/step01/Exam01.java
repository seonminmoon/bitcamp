...
// 즉 src폴더는 소스 파일을 두는 루트 폴더이기 때문에
// 패키지명에 포함해서는 안된다.
package step01;
...
// => 패키지명은 보통 소스파일이 있는 경로와 같게 한다.
//      다르면? 
//      달라도 되는데, 패키지 명과 소스 파일의 경로가
//      다르면 소스파일을 관리하기 힘들 것이다.
// => -d 옵션을 사용하여 컴파일하면 패키지명에 해당하는 폴더가
//      자동으로 생성되고 그 폴더에 .class 파일이 놓인다.
