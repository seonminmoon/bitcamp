...
public class App02 {
    ...
    static void onTeamDelete() {
        ...
        if (team == null) {
            ...
            String yesNo = keyScan.nextLine();
            if (yesNo.toLowerCase().equals("y")) {
            String nameDelete = null;
            team.name  = nameDelete;

            String titleDelete = null;
            team.title  = titleDelete;

            int maxDelete = 0;
            team.maxQty  = maxDelete;

            String startDelete = null;
            team.startDate  = startDelete;

            String endDelete = null;
            team.endDate  = endDelete;
