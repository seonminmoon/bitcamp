...
public class Exam02 extends GenericServlet {
	...
	public void service(
		...
		response.setContentType("text/plain; charset=UTF-8"); // PrintWriter 호출 전에 해야됨!
		// 문자를 출력할 때 사용할 문자코드표 지정하지 않으면,
		// 기본으로 ISO-8859-1 문자표를 사용하여 문자열을 출력한다.
...
// => 원래는 메일을 보낼 때 컨텐츠의 타입을 알려주기 위해 만들었다.
// => 그러나 지금은 메일 뿐만 아니라 다방면에서 콘텐츠의 타입을 지정하는 용도로 사용하고 있다.
// => 예) text/html, text/plain, 