...
public class Exam01 extends HttpServlet {
    ...
    protected void doPost(
        ...
        // 테스트 방법:
        // http://localhost:8888/java106-web01/step05/exam01_test.html
...
/*
POST /java106-web01/step05/exam01 HTTP/1.1
Host: localhost:8888
Content-Length: 190519
Cache-Control: max-age=0
Origin: http://localhost:8888
Upgrade-Insecure-Requests: 1
Content-Type: multipart/form-data; boundary=----WebKitFormBoundaryTWzcvCnLabp2NBYN
...
Referer: http://localhost:8888/java106-web01/step05/exam01_test.html
Accept-Encoding: gzip, deflate, br
Accept-Language: ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7,la;q=0.6

------WebKitFormBoundaryTWzcvCnLabp2NBYN
