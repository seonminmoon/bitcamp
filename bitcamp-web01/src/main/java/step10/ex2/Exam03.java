...
public class Exam03 extends HttpServlet {
    ...
    protected void doGet(
        ...
        // 웹브라우저가 쿠키를 받은 서버에 요청할 때
        // "/java106-web01/step10"으로 시작하는 요청일 경우 c2 쿠키를 보낸다.
        
        Cookie cookie3 = new Cookie("c3", "ccc");
        cookie3.setPath("/bitcamp-web01/step10/ex2/exam04");
        // 웹브라우저가 쿠키를 받은 서버에 요청할 때
        // "/java106-web01/step10/ex2/Exam04"으로 시작하는 요청일 경우 c3 쿠키를 보낸다.
...
//        Content-Length: 27
//        Date: Wed, 23 May 2018 02:25:37 GMT
//        (빈 줄)
//        내용...
    }
}
