...
public class Exam05_3 {
    ...
    // 테스트:
    // http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_3/m2?no=11&title=aaa&content=bbb
    @GetMapping("m1")
    @ResponseBody
    ...
    // 테스트:
    // http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_3/m2?no=11&title=aaa&content=bbb&writer=hongkildong
    @GetMapping("m2")
    @ResponseBody
    ...
    // 테스트:
    // http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_3/m3?no=11&title=aaa&content=bb&user.id=hong&uesr.email=test@test.com&user.password=1111
    @GetMapping("m3")
    @ResponseBody
