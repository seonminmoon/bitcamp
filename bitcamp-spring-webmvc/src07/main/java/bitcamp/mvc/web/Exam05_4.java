...
public class Exam05_4 {
    ...
    // 테스트:
    // http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_4/m2?title=aaa&content=bbb&createdDate=2018-6-05
    @GetMapping("m1")
    @ResponseBody
    ...
    // 그리고 요청이 들어올 때마다 이 메서드를 먼저 실행하도록 설정해야 한다.
    //      @InitBinder 애노테이션을 붙여라
    @InitBinder // 이렇게 표시를 해야만 프론트 컨트롤러가 요청 핸들러를 호출하기 전에 먼저 이 메서드를 호출한다.
    public void initBinder(WebDataBinder binder) {
        // 이 메서드는 요청이 들어올 때 마다 파라미터 값을 준비하기위해
        // 파라미터의 개수 만큼 호출된다.
        System.out.println("Exam05_4().오호라()");
        
        // java.lang.String ===> java.sql.Date 객체로 변환시켜주는 프로퍼티 에디터 등록
