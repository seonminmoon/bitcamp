// 요청 핸들러의 파라미터 - @RequestBody를 사용하여 통으로 넘어온 값을 받기 (값 통째로 받기)
...
public class Exam05_9 {
    ...
    @PostMapping(value="post") // consumes 을 지정해주지 않음
    @ResponseBody
    ...
    public String m2(
            ...
            // 통으로 받아야 한다. 변수 명은 상관 없다.
            // 단 변수명 앞에 @RequestBody 애노테이션을 붙여야 한다.
            @RequestBody String content) {
        return String.format("m2(): %s\n", content);
    }
