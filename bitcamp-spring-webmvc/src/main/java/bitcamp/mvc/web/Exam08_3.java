// 세션 다루기 - @SessionAttribute 애노테이션 사용
...
@SessionAttributes(value={"name","age","working"})
// 의미?
// => name, age 이라는 이름으로 Model(또는 Map) 객체에 저장하는 값들을
//    ServletRequest 뿐만아니라  HttpSession 에도 저장하라는 뜻이다!
//    working 은 값을 지정해주지 않았기 때문에 HttpSession 에 저장되지 않는다.
public class Exam08_3 {
    ...
    public String m1(String name, Model model) {
        ...
        // => Model이나 Map 객체에 데이터르 저장하면, JSP에서 꺼내 쓸 수 있도록
